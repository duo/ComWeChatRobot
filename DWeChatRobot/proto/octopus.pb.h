...
// string hash = 2;
inline void Binary::clear_hash() {
  _impl_.hash_.ClearToEmpty();
}
inline const std::string& Binary::hash() const {
  // @@protoc_insertion_point(field_get:octopus.Binary.hash)
  return _internal_hash();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Binary::set_hash(ArgT0&& arg0, ArgT... args) {
 
 _impl_.hash_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:octopus.Binary.hash)
}
inline std::string* Binary::mutable_hash() {
  std::string* _s = _internal_mutable_hash();
  // @@protoc_insertion_point(field_mutable:octopus.Binary.hash)
  return _s;
}
inline const std::string& Binary::_internal_hash() const {
  return _impl_.hash_.Get();
}
inline void Binary::_internal_set_hash(const std::string& value) {
  
  _impl_.hash_.Set(value, GetArenaForAllocation());
}
inline std::string* Binary::_internal_mutable_hash() {
  
  return _impl_.hash_.Mutable(GetArenaForAllocation());
}
inline std::string* Binary::release_hash() {
  // @@protoc_insertion_point(field_release:octopus.Binary.hash)
  return _impl_.hash_.Release();
}
inline void Binary::set_allocated_hash(std::string* hash) {
  if (hash != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:octopus.Binary.hash)
}
...
inline std::string* Message::mutable_message_id() {
  ...
  // @@protoc_insertion_point(field_mutable:octopus.Message.message_id)
  return _s;
}
...
inline std::string* Message::release_message_id() {
  // @@protoc_insertion_point(field_release:octopus.Message.message_id)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:octopus.Message.message_id)
}
